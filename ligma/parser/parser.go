...
func (p *Parser) parseMapLiteral() runtime.Expression {
	map_ := &runtime.MapLiteral{Token: p.curToken}

	map_.Pairs = make(map[runtime.Expression]runtime.Expression)
